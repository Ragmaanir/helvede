...
echo "--- g++ ---" &&
g++ -std=c++1y -masm=intel -c source/kernel.cpp -o output/objects/kernel.o -ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-rtti -fno-stack-protector -fno-builtin -msse3 -mstackrealign -Wno-unused-parameter
